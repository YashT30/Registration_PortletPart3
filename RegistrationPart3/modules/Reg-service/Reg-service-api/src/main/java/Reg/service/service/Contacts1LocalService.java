...
/**
 * Provides the local service interface for Contacts1. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see Contacts1LocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface Contacts1LocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>Reg.service.service.impl.Contacts1LocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the contacts1 local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link Contacts1LocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Contacts1 updateContacts1(
